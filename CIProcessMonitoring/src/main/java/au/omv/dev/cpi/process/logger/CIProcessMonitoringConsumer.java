 ...
 */
public class CIProcessMonitoringConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(CIProcessMonitoringConsumer.class);

    private final CIProcessMonitoringEndpoint endpoint;


    public CIProcessMonitoringConsumer(final CIProcessMonitoringEndpoint endpoint, final Processor processor) {
