 ...
 */
public class CIProcessMonitoringProducer extends DefaultProducer {
    private static final transient Logger LOG = LoggerFactory.getLogger(CIProcessMonitoringProducer.class);
    private CIProcessMonitoringEndpoint endpoint;

	public CIProcessMonitoringProducer(CIProcessMonitoringEndpoint endpoint) {
        super(endpoint);
